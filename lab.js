...
//Code here
favoriteThings.car = "Honda element",
...
let catOne = new Cat("ChairmanMeow", 3, "white")
...
let MM = new Wizard("Magic Man", 27, "melt")
...
let phoneOne = new Phone('Apple', 'iPhone', 50, 'black', 900)
let phoneTwo = new Phone('LG', 'maxY', 256, 'silver', 1200)
...
//Code Here
let van = new  Vehicle(6, "black", 132000)
...
//Code Here 
let myFirstMotorcycle = new Motorcycle(1, "black", 90000, "honda", "very")
...
//Code Here
const myFirstBoat = new Boat(8, "blue", 200400,"Mrs.Puff", "jetski", )
